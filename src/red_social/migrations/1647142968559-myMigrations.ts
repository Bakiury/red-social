...
export class myMigrations1647142968559 implements MigrationInterface {
    name = 'myMigrations1647142968559'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`my_post\` (\`pos_id\` int NOT NULL AUTO_INCREMENT, \`pos_description\` varchar(256) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(6), \`posUseIdUseId\` int NULL, PRIMARY KEY (\`pos_id\`)) ENGINE=InnoDB`);
